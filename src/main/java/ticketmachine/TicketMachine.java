...
public class TicketMachine {
	 ...
	 */
	public int refund() {
                int balance_retour = balance;
		System.out.println("Je vous rends : " + balance + " centimes");
                balance = 0;
                total -= balance_retour;
		return balance_retour;
	}
	...
	public boolean printTicket() {
		// Simulate the printing of a ticket.
                ...
                // Check if there is enough money in the machine
                if( this.getBalance() >= price)
                {
                    //there is enough money 
                    //   --> print of the ticket and decrease of the balance
                    balance -= price;
